...
if "snakemake" not in dir():
    class snakemake:
        class input:
            ...
            population = "../../results/synthetic/population/population_genes.txt"
        output = [f"../../results/synthetic/recall/results/ora_bayes_recall_0.2_repeat_{i}.csv" for i in range(10)]
